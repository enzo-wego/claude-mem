...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_GEMINI_MAX_CONTEXT_MESSAGES: string;  // Max messages to keep in context window
  CLAUDE_MEM_GEMINI_MAX_TOKENS: string;  // Max estimated tokens for context window
  CLAUDE_MEM_GEMINI_RETRY_MAX_ATTEMPTS: string;  // Max retry attempts for 429 errors
  CLAUDE_MEM_GEMINI_RETRY_BASE_DELAY_MS: string;  // Base delay for exponential backoff
  ...
  CLAUDE_MEM_DISABLE_CLAUDE_FALLBACK: string;  // 'true' | 'false' - disable fallback to Claude on errors
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_DISABLE_CLAUDE_FALLBACK: 'true',  // Never fall back to Claude on provider errors
    // System Configuration
