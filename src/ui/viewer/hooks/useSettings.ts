    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_DISABLE_CLAUDE_FALLBACK: data.CLAUDE_MEM_DISABLE_CLAUDE_FALLBACK || DEFAULT_SETTINGS.CLAUDE_MEM_DISABLE_CLAUDE_FALLBACK,
          ...
          // Project Filtering
          CLAUDE_MEM_IGNORED_PROJECTS: data.CLAUDE_MEM_IGNORED_PROJECTS || DEFAULT_SETTINGS.CLAUDE_MEM_IGNORED_PROJECTS,
          CLAUDE_MEM_ALLOWED_PROJECTS_ONLY: data.CLAUDE_MEM_ALLOWED_PROJECTS_ONLY || DEFAULT_SETTINGS.CLAUDE_MEM_ALLOWED_PROJECTS_ONLY,
        });
      })
      .catch(error => {
