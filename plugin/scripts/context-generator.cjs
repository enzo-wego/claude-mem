...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},m=new W;var Rt={},me="enzo-claude-mem",ue=(0,h.join)((0,U.homedir)(),".claude","plugins","marketplaces",me),Wt=(0,h.join)((0,U.homedir)(),".claude","plugins","cache",me,"claude-mem");function Ot(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,ce.fileURLToPath)(Rt.url))}var Ct=Ot(),N=y.get("CLAUDE_MEM_DATA_DIR"),Y=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,U.homedir)(),".claude"),Yt=(0,h.join)(N,"archives"),Vt=(0,h.join)(N,"logs"),Kt=(0,h.join)(N,"trash"),qt=(0,h.join)(N,"backups"),Jt=(0,h.join)(N,"modes"),zt=(0,h.join)(N,"settings.json"),le=(0,h.join)(N,"claude-mem.db"),Qt=(0,h.join)(N,"vector-db"),Zt=(0,h.join)(Y,"settings.json"),es=(0,h.join)(Y,"commands"),ts=(0,h.join)(Y,"CLAUDE.md");function _e(r){(0,pe.mkdirSync)(r,{recursive:!0})}function Ee(){return(0,h.join)(Ct,"..")}var w=class{db;constructor(e=le){e!==":memory:"&&_e(N),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Ne(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+K)}function It(r){return r.replace(/\//g,"-")}function yt(r){try{if(!(0,j.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,j.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
...
`}function st(r,e,t,s){let n=[];return s?n.push(...Ge(r)):n.push(...Le(r)),s?n.push(...He()):n.push(...Me()),s?n.push(...We()):n.push(...ve()),s?n.push(...Ye()):n.push(...De()),F(t)&&(s?n.push(...Ve(e,t)):n.push(...xe(e,t))),n}var te=L(require("path"),1);function G(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return te.default.isAbsolute(r)?te.default.relative(e,r):r}function at(r,e,t){let s=G(r);if(s.length>0)return rt(s[0],e);if(t){let n=G(t);if(n.length>0)return rt(n[0],e)}return"General"}function At(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=it(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?G(r.facts).join(`
`):null}function Mt(r,e,t,s,n,o){let i=[];o?i.push(...Ke(r)):i.push(...ke(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let l=u.data,g=nt(l.displayTime);o?i.push(...Qe(l,g)):i.push(...Pe(l,g))}else{let l=u.data,g=at(l.files_modified,n,l.files_read),E=ot(l.created_at),T=E!==d,b=T?E:"";d=E;let _=t.has(l.id);if(g!==a&&(c&&i.push(""),o?i.push(...qe(g)):i.push(...$e(g)),a=g,c=!0),_){let S=Lt(l,s);o?i.push(...ze(l,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...we(l,b,S,s)),a=null)}else o?i.push(Je(l,E,T,s)):i.push(Ue(l,b,s))}return c&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=At(r);for(let[a,d]of i)o.push(...Mt(a,d,e,t,s,n));return o}function pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ct(r,e){let t=[];return e?(t.push(...x("Investigated",r.investigated,p.blue)),t.push(...x("Learned",r.learned,p.yellow)),t.push(...x("Completed",r.completed,p.green)),t.push(...x("Next Steps",r.next_steps,p.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function mt(r,e){return e?Ze(r):Fe(r)}function ut(r,e,t){return!F(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):je(r.totalDiscoveryTokens,r.totalReadTokens)}var vt=lt.default.join(ue,"plugin",".install-version");function Dt(){try{return new w}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,_t.unlinkSync)(vt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function xt(r,e){return e?tt(r):Xe(r)}function kt(r,e,t,s,n,o,i){let a=[],d=J(e);a.push(...st(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Ie(c,t),l=ee(e,u),g=ye(e,s.fullObservationCount);a.push(...dt(l,g,s,n,i));let E=t[0],T=e[0];pt(s,E,T)&&a.push(...ct(E,i));let b=Z(e,s,o,n);return a.push(...mt(b,i)),a.push(...ut(d,s,i)),a.join(`
`).trimEnd()}async function se(r,e=!1){let t=V(),s=r?.cwd??process.cwd(),n=fe(s),o=r?.projects||[n],i=Dt();if(!i)return"";try{let a=o.length>1?Re(i,o,t):z(i,n,t),d=o.length>1?Ne(i,o,t):Q(i,n,t);return a.length===0&&d.length===0?xt(n,e):kt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
