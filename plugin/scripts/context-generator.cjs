"use strict";var Et=Object.create;var k=Object.defineProperty;var gt=Object.getOwnPropertyDescriptor;var Tt=Object.getOwnPropertyNames;var ft=Object.getPrototypeOf,St=Object.prototype.hasOwnProperty;var ht=(r,e)=>{for(var t in e)k(r,t,{get:e[t],enumerable:!0})},re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Tt(e))!St.call(r,n)&&n!==t&&k(r,n,{get:()=>e[n],enumerable:!(s=gt(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?Et(ft(r)):{},re(e||!r||!r.__esModule?k(t,"default",{value:r,enumerable:!0}):t,r)),bt=r=>re(k({},"__esModule",{value:!0}),r);var wt={};ht(wt,{generateContext:()=>se});module.exports=bt(wt);var lt=M(require("path"),1),_t=require("fs");var ge=require("bun:sqlite");var h=require("path"),$=require("os"),pe=require("fs");var ce=require("url");var R=require("fs"),U=require("path"),ie=require("os");var ne="bugfix,feature,refactor,discovery,decision,change",oe="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var A=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_PROVIDER:"claude",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_GEMINI_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_GEMINI_MAX_TOKENS:"100000",CLAUDE_MEM_GEMINI_RETRY_MAX_ATTEMPTS:"3",CLAUDE_MEM_GEMINI_RETRY_BASE_DELAY_MS:"1000",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:"claude-mem",CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_DISABLE_CLAUDE_FALLBACK:"true",CLAUDE_MEM_DATA_DIR:(0,U.join)((0,ie.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:ne,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:oe,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",CLAUDE_MEM_FOLDER_CLAUDEMD_ENABLED:"false",CLAUDE_MEM_IGNORED_PROJECTS:"",CLAUDE_MEM_ALLOWED_PROJECTS_ONLY:"",CLAUDE_MEM_GITHUB_ORG:"enzo-wego",CLAUDE_MEM_GITHUB_REPO:"claude-mem"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,R.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,U.dirname)(e);(0,R.existsSync)(a)||(0,R.mkdirSync)(a,{recursive:!0}),(0,R.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return i}let t=(0,R.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,R.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))n[i]!==void 0&&(o[i]=n[i]);return o}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.getAllDefaults()}}};var N=require("fs"),L=require("path"),de=require("os"),H=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(H||{}),ae=(0,L.join)((0,de.homedir)(),".claude-mem"),W=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,L.join)(ae,"logs");(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,L.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,L.join)(ae,"settings.json");if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=H[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},m=new W;var Nt={},me="enzo-claude-mem",ue=(0,h.join)((0,$.homedir)(),".claude","plugins","marketplaces",me),Vt=(0,h.join)((0,$.homedir)(),".claude","plugins","cache",me,"claude-mem"),Ot=A.get("CLAUDE_MEM_GITHUB_ORG"),Ct=A.get("CLAUDE_MEM_GITHUB_REPO"),Kt=`https://github.com/${Ot}/${Ct}`;function Rt(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,ce.fileURLToPath)(Nt.url))}var It=Rt(),I=A.get("CLAUDE_MEM_DATA_DIR"),Y=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,$.homedir)(),".claude"),qt=(0,h.join)(I,"archives"),Jt=(0,h.join)(I,"logs"),zt=(0,h.join)(I,"trash"),Qt=(0,h.join)(I,"backups"),Zt=(0,h.join)(I,"modes"),es=(0,h.join)(I,"settings.json"),le=(0,h.join)(I,"claude-mem.db"),ts=(0,h.join)(I,"vector-db"),ss=(0,h.join)(Y,"settings.json"),rs=(0,h.join)(Y,"commands"),ns=(0,h.join)(Y,"CLAUDE.md");function _e(r){(0,pe.mkdirSync)(r,{recursive:!0})}function Ee(){return(0,h.join)(It,"..")}var w=class{db;constructor(e=le){e!==":memory:"&&_e(I),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
  ...
  `).all(e,...s,...o,t.totalObservationCount)}function Q(r,e,t){return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+K)}function Re(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
...
`}function st(r,e,t,s){let n=[];return s?n.push(...Be(r)):n.push(...Me(r)),s?n.push(...He()):n.push(...Le()),s?n.push(...We()):n.push(...ve()),s?n.push(...Ye()):n.push(...De()),F(t)&&(s?n.push(...Ve(e,t)):n.push(...xe(e,t))),n}var te=M(require("path"),1);function B(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return te.default.isAbsolute(r)?te.default.relative(e,r):r}function at(r,e,t){let s=B(r);if(s.length>0)return rt(s[0],e);if(t){let n=B(t);if(n.length>0)return rt(n[0],e)}return"General"}function Lt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=it(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function vt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?B(r.facts).join(`
`):null}function Dt(r,e,t,s,n,o){let i=[];o?i.push(...Ke(r)):i.push(...ke(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let l=u.data,g=nt(l.displayTime);o?i.push(...Qe(l,g)):i.push(...Pe(l,g))}else{let l=u.data,g=at(l.files_modified,n,l.files_read),E=ot(l.created_at),T=E!==d,b=T?E:"";d=E;let _=t.has(l.id);if(g!==a&&(c&&i.push(""),o?i.push(...qe(g)):i.push(...Ue(g)),a=g,c=!0),_){let S=vt(l,s);o?i.push(...ze(l,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...we(l,b,S,s)),a=null)}else o?i.push(Je(l,E,T,s)):i.push($e(l,b,s))}return c&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=Lt(r);for(let[a,d]of i)o.push(...Dt(a,d,e,t,s,n));return o}function pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ct(r,e){let t=[];return e?(t.push(...x("Investigated",r.investigated,p.blue)),t.push(...x("Learned",r.learned,p.yellow)),t.push(...x("Completed",r.completed,p.green)),t.push(...x("Next Steps",r.next_steps,p.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function mt(r,e){return e?Ze(r):Fe(r)}function ut(r,e,t){return!F(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):je(r.totalDiscoveryTokens,r.totalReadTokens)}var xt=lt.default.join(ue,"plugin",".install-version");function kt(){try{return new w}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,_t.unlinkSync)(xt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ut(r,e){return e?tt(r):Xe(r)}function $t(r,e,t,s,n,o,i){let a=[],d=J(e);a.push(...st(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Ne(c,t),l=ee(e,u),g=Ae(e,s.fullObservationCount);a.push(...dt(l,g,s,n,i));let E=t[0],T=e[0];pt(s,E,T)&&a.push(...ct(E,i));let b=Z(e,s,o,n);return a.push(...mt(b,i)),a.push(...ut(d,s,i)),a.join(`
`).trimEnd()}async function se(r,e=!1){let t=V(),s=r?.cwd??process.cwd(),n=fe(s),o=r?.projects||[n],i=kt();if(!i)return"";try{let a=o.length>1?Re(i,o,t):z(i,n,t),d=o.length>1?Ie(i,o,t):Q(i,n,t);return a.length===0&&d.length===0?Ut(n,e):$t(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
